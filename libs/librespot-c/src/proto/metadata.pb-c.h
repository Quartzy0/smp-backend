...
typedef struct _ArtistWithRole ArtistWithRole;
typedef struct _Show Show;
typedef struct _Episode Episode;
typedef struct _Licensor Licensor;
...
typedef struct _ContentRating ContentRating;
...
typedef enum _Album__Type {
  ...
  ALBUM__TYPE__EP = 4,
  ALBUM__TYPE__AUDIOBOOK = 5,
  ALBUM__TYPE__PODCAST = 6
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ALBUM__TYPE)
} Album__Type;
typedef enum _ArtistWithRole__ArtistRole {
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_UNKNOWN = 0,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_MAIN_ARTIST = 1,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_FEATURED_ARTIST = 2,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_REMIXER = 3,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_ACTOR = 4,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_COMPOSER = 5,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_CONDUCTOR = 6,
  ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_ORCHESTRA = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(ARTIST_WITH_ROLE__ARTIST_ROLE)
...
typedef enum _Episode__EpisodeType {
  EPISODE__EPISODE_TYPE__FULL = 0,
  EPISODE__EPISODE_TYPE__TRAILER = 1,
  EPISODE__EPISODE_TYPE__BONUS = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(EPISODE__EPISODE_TYPE)
...
typedef enum _AudioFile__Format {
  ...
  AUDIO_FILE__FORMAT__AAC_24 = 8,
  AUDIO_FILE__FORMAT__AAC_48 = 9,
  AUDIO_FILE__FORMAT__FLAC_FLAC = 16
...
#define ALBUM__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&album__descriptor) \
    , 0, {0,NULL}, NULL, 0,NULL, 0, ALBUM__TYPE__ALBUM, NULL, NULL, 0, 0, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, NULL, NULL, NULL, NULL, 0,NULL }
...
struct  _Track
{
  ...
  ArtistWithRole **artist_with_role;
};
#define TRACK__INIT \
...
struct  _ArtistWithRole
{
  ...
  ArtistWithRole__ArtistRole role;
};
#define ARTIST_WITH_ROLE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&artist_with_role__descriptor) \
    , 0, {0,NULL}, NULL, 0, ARTIST_WITH_ROLE__ARTIST_ROLE__ARTIST_ROLE_UNKNOWN }
...
#define SHOW__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&show__descriptor) \
    , 0, {0,NULL}, NULL, NULL, 0, 0, NULL, NULL, 0, 0, NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, 0, SHOW__MEDIA_TYPE__MIXED, 0, SHOW__CONSUMPTION_ORDER__SEQUENTIAL, 0,NULL, NULL, 0, 0, 0, 0 }
...
#define EPISODE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&episode__descriptor) \
    , 0, {0,NULL}, NULL, 0, 0, 0,NULL, NULL, 0, 0, NULL, 0, 0, NULL, NULL, 0, 0, NULL, 0,NULL, 0,NULL, 0,NULL, 0,NULL, NULL, 0,NULL, 0, 0, 0,NULL, NULL, 0, EPISODE__EPISODE_TYPE__FULL, 0, 0, 0,NULL, 0, 0 }
...
#define LICENSOR__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&licensor__descriptor) \
    , 0, {0,NULL} }
...
typedef enum {
  RESTRICTION__COUNTRY_RESTRICTION__NOT_SET = 0,
  RESTRICTION__COUNTRY_RESTRICTION_COUNTRIES_ALLOWED = 2,
  RESTRICTION__COUNTRY_RESTRICTION_COUNTRIES_FORBIDDEN = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(RESTRICTION__COUNTRY_RESTRICTION)
} Restriction__CountryRestrictionCase;
...
struct  _Restriction
{
  ...
  protobuf_c_boolean has_type;
  Restriction__Type type;
  size_t n_catalogue_str;
  char **catalogue_str;
  Restriction__CountryRestrictionCase country_restriction_case;
  union {
...
#define RESTRICTION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&restriction__descriptor) \
    , 0,NULL, 0, RESTRICTION__TYPE__STREAMING, 0,NULL, RESTRICTION__COUNTRY_RESTRICTION__NOT_SET, {0} }
...
#define CONTENT_RATING__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&content_rating__descriptor) \
    , NULL, 0,NULL }
...
typedef void (*Track_Closure)
                 (const Track *message,
                  void *closure_data);
typedef void (*ArtistWithRole_Closure)
                 (const ArtistWithRole *message,
                  void *closure_data);
...
typedef void (*VideoFile_Closure)
                 (const VideoFile *message,
                  void *closure_data);
typedef void (*ContentRating_Closure)
                 (const ContentRating *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor artist_with_role__descriptor;
extern const ProtobufCEnumDescriptor    artist_with_role__artist_role__descriptor;
...
extern const ProtobufCEnumDescriptor    episode__episode_type__descriptor;
extern const ProtobufCMessageDescriptor licensor__descriptor;
...
extern const ProtobufCMessageDescriptor content_rating__descriptor;
