...
static const ProtobufCEnumValue platform__enum_values_by_number[41] =
{
  ...
  { "PLATFORM_WEBPLAYER", "PLATFORM__PLATFORM_WEBPLAYER", 24 },
  { "PLATFORM_WP8_ARM", "PLATFORM__PLATFORM_WP8_ARM", 25 },
  { "PLATFORM_WP8_X86", "PLATFORM__PLATFORM_WP8_X86", 26 },
  { "PLATFORM_WINRT_ARM", "PLATFORM__PLATFORM_WINRT_ARM", 27 },
  { "PLATFORM_WINRT_X86", "PLATFORM__PLATFORM_WINRT_X86", 28 },
  { "PLATFORM_WINRT_X86_64", "PLATFORM__PLATFORM_WINRT_X86_64", 29 },
  { "PLATFORM_FRONTIER", "PLATFORM__PLATFORM_FRONTIER", 30 },
  { "PLATFORM_AMIGA_PPC", "PLATFORM__PLATFORM_AMIGA_PPC", 31 },
  { "PLATFORM_NANRADIO_NRX901", "PLATFORM__PLATFORM_NANRADIO_NRX901", 32 },
  { "PLATFORM_HARMAN_ARM", "PLATFORM__PLATFORM_HARMAN_ARM", 33 },
  { "PLATFORM_SONY_PS3", "PLATFORM__PLATFORM_SONY_PS3", 34 },
  { "PLATFORM_SONY_PS4", "PLATFORM__PLATFORM_SONY_PS4", 35 },
  { "PLATFORM_IPHONE_ARM64", "PLATFORM__PLATFORM_IPHONE_ARM64", 36 },
  { "PLATFORM_RTEMS_PPC", "PLATFORM__PLATFORM_RTEMS_PPC", 37 },
  { "PLATFORM_GENERIC_PARTNER", "PLATFORM__PLATFORM_GENERIC_PARTNER", 38 },
  { "PLATFORM_WIN32_X86_64", "PLATFORM__PLATFORM_WIN32_X86_64", 39 },
  { "PLATFORM_WATCHOS", "PLATFORM__PLATFORM_WATCHOS", 40 },
};
static const ProtobufCIntRange platform__value_ranges[] = {
{0, 0},{0, 41}
};
static const ProtobufCEnumValueIndex platform__enum_values_by_name[41] =
{
